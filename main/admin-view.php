...
<body>
    ...
    <div id="page">
        ...
        <section id="container">
            ...
            <div class ="content">
            	<h2 id ="admin-chap">Chapitres postés</h2>
                <?php
                    try
                    {
                    ...
                    $reponse = $bdd->query('SELECT id, titre, SUBSTRING(texte,1,550) AS debut_chap FROM chapitres ');

                    while ($donnees = $reponse->fetch()) 
                        {
                            echo "<p class ='titre-chap'> " . htmlspecialchars($donnees['titre']) . "</p>" ;
                            echo "<p class ='chap'>". htmlspecialchars($donnees['debut_chap']) . "</p>";
                            echo "<div id ='lesModif'>";
                            echo "<a class = 'afficher-chap' href='chapitres.php?chap=".$donnees['id'] ."'>Afficher</a>";
                            echo "<a class = 'modif-chap' href='modifier.php?chap=".$donnees['id'] ."'>Modifier</a>";
                            echo "</div>";
                        }
